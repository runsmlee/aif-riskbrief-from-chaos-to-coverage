...
export function Header({ className = '' }: HeaderProps): ReactElement {
  ...
  const toggleDarkMode = useCallback(() => {
    setDarkMode((prev) => {
      ...
      try {
        localStorage.setItem('riskbrief-theme', next ? 'dark' : 'light');
      } catch {
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <button
              ...
              className="p-2 rounded-lg hover:bg-gray-100 transition-colors focus-visible:outline-2 focus-visible:outline-primary-500"
